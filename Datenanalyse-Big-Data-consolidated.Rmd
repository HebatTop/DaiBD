...
**As it is shown in @partitioned_reg[p. 12 - 16] it is possible to reformualte a regression problem by dividing it in subproblems in this way.**
...
* consolidation of all parts and formating paper
